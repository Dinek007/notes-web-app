...
import { Box, CircularProgress, IconButton, ListItemButton, ListItemIcon, ListItemText, Typography } from '@mui/material'
...
export const NotesFieldComponent = () => {
    ...
    const areFoldersAndNotesLoading = useSelector(sessionSelectors.foldersAndNotesLoading)
    ...
    const currentCategoryNotes = currentCategoryData ? Object.values(currentCategoryData.notes.entities) : []
    ...
    }, [currentCategoryName, areFoldersAndNotesLoading])
        ...
        <Box sx={{
            ...
            {pageToShow === pageNames.home &&
                < Box
                    ...
                    <Typography style={{
                        marginTop: '20px'
                    }}> Folders count: {dataCounts.folders} </Typography>
                    ...
                    <Box sx={{
                        ...
                        {Object.values(foldersAndNotes).map((folder) => {
                            return (
                                <HomePageComponent folder={folder} />
                            )
                        })}
                    </Box>
                </Box>

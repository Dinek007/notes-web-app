...
export function* notesMasterSaga(): Generator {
  yield all([
    takeEvery(
      notesActions.newCategory.type,
      newCategorySaga
    ),
    takeEvery(
      notesActions.newNote.type,
      newNoteSaga
    ),
    takeEvery(
      notesActions.getCategoriesAndNotes.type,
      newCategorySaga
    ),
    takeEvery(
      notesActions.removeCategory.type,
      removeCategorySaga
    ),
    takeEvery(
      notesActions.removeNote.type,
      removeNoteSaga
    ),
    takeEvery(
      notesActions.updateNote.type,
      updateNoteSaga
    ),
  ])
}   